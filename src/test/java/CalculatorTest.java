...
public class CalculatorTest {
    ...
    public void factorialTruePositive(){
        ...
        assertEquals("factorial of a number for True Positive", 24, calculator.factorial(4), DELTA);
    }
    ...
    public void powerFalsePositive(){
        assertNotEquals("power for False Positive", 6, calculator.power(2, 2), DELTA);
